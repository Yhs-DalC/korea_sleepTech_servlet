...
public class Servlet01 {
    ...
    *
    * 1. 서블릿이란?
    * : 자카 언어로 작성된 웹 서버에서 실행되는 프로그램
    * - 클라이언트의 요청을 처리하고 응답을 생성하는 역할
    * >> 웹 애플리케이션의 백엔드 역할을 하는 자바 클래스
    *
    * 2. 서블릿 사용 목적
    * : '요청을 처리하고 응답을 생성'하는 프로그램이 '서블릿'
    *
    * cf) 웹 애플리케이션의 동작 구조
    ...
    * 
    * 6. 용어 정리
    * 1) 서블릿: HTTP요청 처리 자바 클래스
    * 2) 컨테이너: 서블릿을 실행시켜주는 환경(톰캣, 아파치)
    ...
    * >> 요청을 DispatcherServlet이 받아 컨트롤러, 서비스, 시포지토리 등의 역할을 분담하여 동작시킴
    *       + 결과를 모아 응답 전송
    * */
}
